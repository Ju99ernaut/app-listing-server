...
@router.get("/users/me", response_model=List[RatingReturn])
...
@router.get("/users/me/{application}", response_model=RatingReturn)
...
@router.post("/users/me/{application}", response_model=RatingReturn)
